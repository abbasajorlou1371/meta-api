                                ...
                                <div style="border-top:0px solid transparent; border-left:4px solid #fd7e14; border-bottom:0px solid transparent; border-right:4px solid #fd7e14; padding-top:55px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;direction: rtl;">
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            ...
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">شناسه شهروندی<span> : </span><a href="https://rgb.irpsc.com/citizen/{{ \Illuminate\Support\Str::upper($joinRequest->toUser->code) }}"style="color:#fd7e14">{{ \Illuminate\Support\Str::upper($joinRequest->toUser->code) }}</a></span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">نام<span> : </span>{{ $joinRequest->toUser->kyc->fname }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">نام خانوادگی<span> : </span>{{ $joinRequest->toUser->kyc->lname }}</span></p><hr style="border-color:#795E8B;">
                                            ...
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px;">سطح<span> : </span>{{ $joinRequest->toUser->level->slug ?? '0' }}</span></p><hr style="border-width:3px;border-color:#795E8B;">
                                        </div>
                                    </div>
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:55px; padding-bottom:55px; padding-right: 30px; padding-left: 30px;">
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:20px;padding-left:25px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            ...
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 22px;"><span>تاریخ اعتبار تا 24 ساعت پس از ثبت درخواست</span><br><span>ساعت ثبت : <span>{{ \Morilog\Jalali\Jalalian::forge($joinRequest->created)->format('H:m:s') }}</span><br><span>تاریخ ثبت : </span><span>{{ \Morilog\Jalali\Jalalian::forge($joinRequest->created)->format('Y/m/d') }}</span></span> </span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
